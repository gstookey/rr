...
- Packets:
- [**ACME-INVENT-01 — the DDD reference application** (`acme-invent-01`)](../design/packets/acme-invent-01-design-packet/README.md) — `exploratory`, cut 2026-09-03; EP-06 (#37), stories S-18..S-25 (#38–#45); **not activated**
  - [Domain Model v0](../design/packets/acme-invent-01-design-packet/domain_model_v0.md) · [Decision Register v0 (AI-D1..AI-D12)](../design/packets/acme-invent-01-design-packet/decision_register_v0.md) · [Slice Decomposition v0 (S0..S7)](../design/packets/acme-invent-01-design-packet/slice_decomposition_v0.md)
