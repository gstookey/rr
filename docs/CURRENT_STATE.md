...
- **Milestone-1 PR #29 merged 2026-09-03:** reconciled shells walked 17→19 in the real layout, ADR-005, the 17→19 pool + slicer + tested rebuild script, offline verification v2, context sync. Awaiting Graham's review + merge.
...
- **Side-quest lane (design only):** DDD-ARCH-01 — pass 1 merged (PR #30); **pass 2** (currency contract + all seven briefs modernized to the 2026 signal-first Angular idiom + canonical stack corrections + C-009) on branch `claude/ddd-arch-01-modernization-pass-2`, **PR #32 pending**. Next step: Graham reads R1..R7 (pass 2 supersedes the pass-1 read) and rules round 1 (DA-D1..D6, D8).
