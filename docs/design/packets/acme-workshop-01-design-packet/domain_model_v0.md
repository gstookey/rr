...
|---|---|---|---|---|
| **Tick-Tock Watchworks** (`TTW`) | manufacturer | `TTW` (dominates `TTW/NWL`: a manufacturer sees the devices its B2B customers operate — **AW-D13 ruled A, 2026-09-04**) | Invent · Command · Vigilance · Front Desk | *Ada* (inventory manager), *Bram* (release engineer), *Cy* (TTW group admin) |
