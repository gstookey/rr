...
**Created:** 2026-08-25 | **Last updated:** 2026-09-03 (packets `ddd-arch-01` and `acme-invent-01` added)
...
- `packets/` — design packets (`<TOPIC>-NN-design-packet/README.md` + decision register), the unit of design work Axium cuts and Graham accepts.
  - [`acme-invent-01-design-packet/`](packets/acme-invent-01-design-packet/README.md) — **ACME Invent**, the DDD reference application (2026-09-03, `exploratory`, EP-06 #37, stories S-18..S-25, **not activated**): a fictional smart-watch-manufacturer hub (Front Desk · Warehouse · Control · Status) built in the real `apps/ packages/ services/` layout as the walking skeleton of DDD-ARCH-01 and the LOE-8 scaffold.
